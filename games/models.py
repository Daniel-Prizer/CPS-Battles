...
class Games(models.Model):
    ...
    player_one_cps = models.FloatField(default=0, null=True)
    player_one_clicks = models.FloatField(default=0, null=True)
    ...
    player_two_clicks = models.FloatField(default=0, null=True)
